    ...
    <div class="landing-page">
        <div class="on-mobile">
            ...
            <div class="mobile-table">
                ...
                <img class="no-mobile" src="./../../public/icons/sad_kitty.png">
            </div>
        </div>
        <div class="header-landing">
            <img class="kitty-logo" src="./../../public/icons/logo.png">
            ...
            <div class="info-pages">
                ...
                >
                    <div class="intro-top">
                        ...
                        <h3><i>Anything is passion</i></h3>
                        <br>
                        <p>kitty is the best place on the internet to meet amazing kittens and their owners!</p>
                        <p>Browse through local cats and connect with their owners to set up a playdate or a walk.</p>
                        <p>If you like a cat and their owner likes your cat back, then you will match!</p>
                    </div>
                </div>
                <div
                        v-if="!intro && features && !about"
                    ...
                    <div class="row1">
                        ...
                        <div class="column1">
                            <h3>Sign up</h3>
                            <p>Make a profile that shows off your cat and their personality!<p>
                    ...
                    <div class="row2">
                        <div class="column2">
                            <h3>Browse</h3>
                            <p>Use a familiar and intuitive interface to see cats in your area</p>
                    ...
                    <div class="row3">
                        ...
                        <div class="column3">
                            ...
                            <p>Display the contact email for matched cats and make plans to connect.</p>
                        </div>
                    </div>
                </div>
                <div
                        ...
                        class="about">
                    <h3>Why Pkitty?</h3>
                    <p>This is my Portfolio Project, concluding our Foundations Year at <a href="https://www.alx.com/">alx School</a>.
                    ...
                    <p>The idea of cats came from the friends's passion for catss.
                        We know that cats need to socialize as much as humans and we wanted to create a fun and intuitive interface
                        to connect dog owners.</p>
                    <br>
                    <h4>The Team</h4>
                    
                    <br>
                    <h4>Check out the source code for kitty!</h4>
                    <a href="https://github.com/Mangah02/kitty">kitty on GitHub</a>
                </div>
            </div>
        </div>
